...
#### Curl 请求示例
```
curl -X GET -H "Authorization: Basic xxxxxx" -H “Accept: application/vnd.apache.kylin-v2+json" http://host:port/kylin/api/kap/user/users?pageSize=9&pageOffset=0&project=default
```
#### 响应示例
```json
{
...
#### Curl 请求示例
```
curl -X POST -H "Authorization: Basic xxxxxx" -H “Accept: application/vnd.apache.kylin-v2+json" -d '{ "username":"test", "password":"KYLIN"，“disabled”:false，“authorities”:["ROLE_ADMIN"] }' http://host:port/kylin/api/kap/user/t
```
#### 响应示例
```json
{
...
#### Curl 请求示例
```
curl -X PUT -H "Authorization: Basic xxxxxx" -H “Accept: application/vnd.apache.kylin-v2+json" -d '{ "username":"test", "password":"KYLIN"，“disabled”:false，“authorities”:["ROLE_ADMIN"] }' http://host:port/kylin/api/kap/user/t
```
#### 响应示例
```json
{
...
#### Curl 请求示例
```
curl -X DELETE -H "Authorization: Basic xxxxxx" -H “Accept: application/vnd.apache.kylin-v2+json" http://host:port/kylin/api/kap/user/t
```