...
- HTTP Body: JSON Object
  ...
  - `startOffset` - `required` `long`, the start value (inclusive) of the new segment range. Should be a number that represents a point in time. For example, with the "YYYYMMDD+Hour+BatchNum" format, 2018042210000 stands for the 1st batch of 10 am 2018-4-22. The last 3 digits are batch sequence number.
